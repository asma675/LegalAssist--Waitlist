          ...
          <div className="sticky top-6 space-y-4">
            ...
            <div className="rounded-3xl border border-white/40 bg-white/70 p-4 shadow-soft backdrop-blur">
              ...
              <div className="mt-1 text-xs text-slate-600">
                LegalAssist does not provide legal advice and does not create an attorney-client
                relationship.
              </div>
            </div>
          </div>
        ...
        <div className="flex-1 space-y-6">
          ...
          >
            <div className="rounded-[26px] bg-gradient-to-br from-slate-950 via-ink-900 to-ink-700 p-7 text-white md:p-10">
              ...
              <p className="mt-3 max-w-2xl text-sm text-white/80 md:text-base">
                Manage clients, cases, tasks, documents, and AI workflows in one place. Generate legal
                documents, analyze uploaded files, and get structured case strategy outputs — faster
                and more organized.
              </p>
          ...
          >
            <h2 className="text-2xl font-semibold tracking-tight text-slate-900">
              What LegalAssist helps you do
            </h2>
            <p className="mt-2 text-sm text-slate-600">
              Built to mirror end-to-end legal workflows: intake → case workspace → documents →
              analysis.
            </p>
            ...
            <div className="mt-6 grid gap-4 md:grid-cols-3">
              {[
                ...
                <div
                  key={f.title}
                  className="rounded-3xl border border-white/60 bg-white/60 p-5 backdrop-blur"
                >
            ...
            <div className="mt-6 rounded-2xl border border-amber-200 bg-amber-50 px-4 py-3 text-xs text-amber-900">
              Disclaimer: LegalAssist does not provide legal advice and does not create an
              attorney-client relationship. AI outputs are informational and must be reviewed by a
              qualified attorney.
            </div>
          </section>
          ...
          >
            ...
            <p className="mt-2 text-sm text-slate-600">
              A quick walkthrough of the dashboard, document analyzer, and legal research.
            </p>

            <div className="mt-5 overflow-hidden rounded-3xl border border-white/60 bg-black">
              <div className="aspect-video w-full">
                <video
                  ...
                  playsInline
                  preload="metadata"
                  poster="/screens/app-1.png"
                >
                  <source src="/demo/legalassist-demo.mp4" type="video/mp4" />
            ...
            <div className="mt-3 text-xs text-slate-500">
              Video path expected: <code className="rounded bg-slate-100 px-1">/public/demo/legalassist-demo.mp4</code>
            </div>
          </section>
          ...
          >
            ...
            <p className="mt-2 text-sm text-slate-600">
              These are pulled directly from your UI. Add/remove images in{" "}
          ...
          >
            ...
            <div className="mt-6 grid gap-4 md:grid-cols-3">
              ...
              <div className="rounded-3xl border border-white/60 bg-white/60 p-6 backdrop-blur">
                ...
                <div className="mt-1 text-xs text-slate-600">
                  For multi-user teams and firms
                </div>
            ...
            <div className="mt-6 text-xs text-slate-500">
              Note: Pricing is preliminary and may change during beta. Waitlist members get early
              access and launch offers.
            </div>
          </section>
          ...
          >
            ...
            <p className="mt-2 text-sm text-slate-600">
              ...
              <code className="rounded bg-slate-100 px-1">WAITLIST_WEBHOOK_URL</code> in
              Vercel to save signups to your backend/Zapier.
            </p>
            ...
            <form action="/api/waitlist" method="POST" className="mt-6 grid gap-4 md:grid-cols-2">
              ...
              <div className="md:col-span-2">
                <label className="text-xs font-semibold text-slate-700">
                  What would you use LegalAssist for first?
                </label>
                <textarea
                  name="note"
                  rows={3}
            ...
            <div className="mt-6 rounded-2xl border border-white/60 bg-white/60 px-4 py-3 text-xs text-slate-600">
              Legal Disclaimer: LegalAssist does not provide legal advice and does not create an
              attorney-client relationship. All AI-generated content is for informational purposes
